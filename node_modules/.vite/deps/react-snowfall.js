...
var useSnowfallStyle = (overrides) => {
  const styles = (0, import_react.useMemo)(() => Object.assign(Object.assign({}, snowfallBaseStyle), overrides || {}), [overrides]);
  return styles;
};
...
// node_modules/react-snowfall/lib/Snowfall.js
var Snowfall = ({ color = defaultConfig.color, changeFrequency = defaultConfig.changeFrequency, radius = defaultConfig.radius, speed = defaultConfig.speed, wind = defaultConfig.wind, rotationSpeed = defaultConfig.rotationSpeed, snowflakeCount = 150, images, style } = {}) => {
